...
ConfigEntry config_entry_options[] = {
    ...
    {SINGLE_INPUT,
     PROGRESS_TOKEN,
     "Verbosity of the output, default is 1 [0: no progress is printed, 2: detailed progress]",
     set_progress},
    {SINGLE_INPUT,
     NO_PROGRESS_TOKEN,
...
ConfigEntry config_entry_psy[] = {
    ...
    {SINGLE_INPUT,
     SHARPNESS_TOKEN,
     "[PSY] Affects loopfilter deblock sharpness and rate distortion, default is 2 [-14 to 14]",
     set_cfg_generic_token},
    // QP scale compress
    {SINGLE_INPUT,
     QP_SCALE_COMPRESS_STRENGTH_TOKEN,
     "[PSY] QP scale compress strength, default is 1.0 [0.0-8.0]",
     set_cfg_generic_token},
    ...
    {SINGLE_INPUT,
     ...
     set_cfg_generic_token},
    {SINGLE_INPUT,
     LINEART_ENERGY_BIAS_TOKEN,
     "Bias `--ac-bias` so that high variance regions prefer higher energy even if it's higher than the source. [1.0-1.5]",
     set_cfg_generic_token},
    {SINGLE_INPUT,
     TEXTURE_ENERGY_BIAS_TOKEN,
    ...
    {SINGLE_INPUT,
     ...
     "[PSY] Balancing luminance lambda bias [0.0-0.999]",
     set_cfg_generic_token},
    {SINGLE_INPUT,
     BALANCING_TEXTURE_LAMBDA_BIAS_TOKEN,
     "[PSY] Balancing texture lambda bias [0.0-0.999]",
     set_cfg_generic_token},
    {SINGLE_INPUT,
